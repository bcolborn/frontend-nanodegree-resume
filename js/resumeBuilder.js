...
function publicationsDisplay(pubs) {
    ...
    for (var item in pubs) {
        ...
        $(".publication-entry:last").append(HTMLpublicationTitle.replace("%data%",
            pubs[item].Name).replace("%url%", pubs[item].Url));
        $(".publication-entry:last").append(HTMLpublicationPublisher.replace("%data%", pubs[item].Publisher));
        $(".publication-entry:last").append(HTMLpublicationDates.replace("%data%", convertDate(pubs[item].Date)));
        $(".publication-entry:last").append(HTMLgeneralDescription.replace("%data%",
